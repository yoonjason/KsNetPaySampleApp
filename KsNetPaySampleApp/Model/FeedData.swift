...
let feedSamples = [
    ...
    Feeds(name: "이지금", profileImage: "imgProfilePublicM", description: "셀럽으로서의 화려한 삶을 사는 아이유 언제나 그녀를 향해 터지는 카메라 수없이 쏟아지는 스포트라이트를 피해 하루 동안 일탈을 감행하던 중 우연히 자신과 똑같은 얼굴을 한 여자와 마주치고홀린 듯 그녀를 쫓게 된다. 같은 얼굴에 전혀 다른 표정을 하고 선 두사람. 그들은 과연 마주볼 수 있을까?", likeCount: 15, replyCount: 4, image: "iu"),
